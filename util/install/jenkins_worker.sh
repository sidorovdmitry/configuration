...
##
cd /var/tmp
git clone https://github.com/raccoongang/configuration
cd configuration
...
##
cd /var/tmp/configuration/playbooks/edx-east && sudo -E ansible-playbook -c local ./jenkins_worker.yml -i "localhost,"
