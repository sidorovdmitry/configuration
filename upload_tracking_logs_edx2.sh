...
$CONFIGURATION_VENV_BIN_PATH/ansible-playbook -i $HOSTS_FILE -e@$SERVER_VARS $CONFIGURATION_REPO_PATH/playbooks/run_role.yml -e "role=tracking-log-hdfs-upload-job" --limit=edx2
