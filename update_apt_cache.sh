...
$CONFIGURATION_VENV_BIN_PATH/ansible-playbook -i $HOSTS_FILE -e@$SERVER_VARS $CONFIGURATION_REPO_PATH/playbooks/update-apt-cache.yml --limit all_host_rds_multitenant
